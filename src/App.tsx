...
function App() {
  return (
    <div className="min-[375px]:py-[64px] min-[375px]:px-[32px] md:py-[80px] min-[1440px]:p-[112px] min-[1440px]:grid min-[1440px]:grid-cols-2">
      <ImageGrid />
      <div className="min-[1440px]:pl-[32px]">
